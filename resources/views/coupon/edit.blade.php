                ...
                <div class="box">
                    ...
                    <div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
                        <label for="type" class="control-label">{{ 'Type' }}</label>
                         ...
                         <option value="1" @if($coupon->type == 1) selected="selected" @endif>Amount</option>
                         <option value="0" @if($coupon->type == 0) selected="selected" @endif>Percentage</option>
                         </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <a href="{{ route('coupon.index') }}" title="Back" class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
                    </div>
                    </div>
                    </form>
                    </div>
