 ...
 <div class="col-xs-12 col-sm-12 col-md-12 {{ $errors->has('Subcategories') ? 'has-error' : ''}}">
    <div class="form-group">
                    ...
                    <select class="form-control" name="subcategory" id="subcategory"data-parsley-required="true">
                    <option value=""> </option>
                    </select>
</div>
</div>
...
<div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" name="description" type="text" id="description" value="{{ isset($product->description) ? $product->description : ''}}" ></textarea>
